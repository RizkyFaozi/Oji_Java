 ...
 * @author ASUS
 */
public class Validasi_petugas extends javax.swing.JFrame {

    /**
     * Creates new form Validasi
     */
    public Validasi_petugas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Verifikasi Dan Validasi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Validasi_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Validasi_petugas().setVisible(true);
            }
        });
    }
