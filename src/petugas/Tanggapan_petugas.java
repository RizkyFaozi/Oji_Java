 ...
 * @author ASUS
 */
public class Tanggapan_petugas extends javax.swing.JFrame {

    /**
     * Creates new form Validasi
     */
    public Tanggapan_petugas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tanggapan_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tanggapan_petugas().setVisible(true);
            }
        });
    }
